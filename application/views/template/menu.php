            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Kelola Data Booking <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i>Kelola Data Kavling<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
